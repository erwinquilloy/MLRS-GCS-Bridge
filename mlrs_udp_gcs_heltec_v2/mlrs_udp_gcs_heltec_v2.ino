...
void oled_telem() {
    ...
    // ArduPlane (fixed-wing or VTOL) gets a real or EKF-synthesised airspeed
    // alongside GS; iNav without a pitot mirrors GS, and copters have no
    // meaningful airspeed - show GS only in those cases.
